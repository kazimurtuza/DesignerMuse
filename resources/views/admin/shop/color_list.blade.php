...
{{--            </div>--}}
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    @foreach($color as $key=>$colorList)
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>
                                {{$colorList->name}}
                            </td>
                            <td><div class="colorCoseshow" style="background: {{$colorList->color_code}}"></div> </td>
                            <td>
                                <div class="dropdown dropstyle">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="#" onclick="editColor({{$colorList}})">Edit</a>
                                    </div>
                                </div>
                            </td>
