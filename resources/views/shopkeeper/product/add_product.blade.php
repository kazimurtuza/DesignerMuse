                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="colorset">
                                                    <div id="color_varient" style="display: none">
                                                        {{--                                                        <select class="form-control select2" name="color[]" onchange="newcolorItem(this)"--}}
                                                        {{--                                                                style="width: 100%;">--}}
                                                    ...
                                                    <div id="no_variant" >
                                                        <div class="form-group">
                                                            <div class="select2-purple">
                                                                ...
                                                                <select class="js-example-basic-multiple w-100" name="color_no_variant[]" multiple="multiple" placeholder="color">
                                    ...
                                    <div class="mb-3">
                                        <label for="inputProductDescription" class="form-label">3D Image  (only glb Type)</label>
                                        <br>
{{--                                        accept=".glb"--}}
                                        <input type="file" name="img_data" accept=".glb">
