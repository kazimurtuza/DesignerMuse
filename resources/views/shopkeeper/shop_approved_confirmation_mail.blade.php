                                    ...
                                    <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;" align="left">
                                        <div
                                            ...
                                            <h2 style="font-family: Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-weight: 500;font-size: 20px;color: #4F545C;letter-spacing: 0.27px;">
                                                Hey {{$details['name']}},</h2>
                                            <p>Your Shop has been approved now you can login to your account.</p>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;"
                                                    ...
                                                    <a href="{{route('frontend.user.login')}}" style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
                                                       Login Account
                                                    </a></td>
                                            </tr>
                                            </tbody>
