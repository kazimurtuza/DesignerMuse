        ...
        <div class="projects-container container">
            <ul>
              ...
              <span class="icon">
                ...
                <li>
                    <a href="{{route('designer.profile.setting')}}">
              <span class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4.21 5.61">
                  <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                ...
                <li>
                    <a href="{{route('designer.meeting.list')}}">
              <span class="icon">
                ...
                <li>
                    <a href="{{route('designer.project.list')}}">
              <span class="icon">
                ...
                <li>
                    <a href="{{route('time.schedule.list')}}">
              <span class="icon">
                ...
                <li>
                    <a href="{{route('designer.package.setting')}}">
              <span class="icon">
                <svg
                    version="1.1"
