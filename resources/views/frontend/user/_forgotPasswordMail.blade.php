                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;"
                                                    ...
                                                    <a href="{{route('user.reset.password',['user_id'=>$details['user_id'],'user_type'=>$details['user_type']])}}" style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
                                                        Reset Password
                                                    </a></td>
                                            </tr>
                                            </tbody>
