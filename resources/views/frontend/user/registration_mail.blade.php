                                        ...
                                        <div
                                            ...
                                            <p>
                                                <img
                                                    ...
                                                    alt="Party Wumpus" title="None" width="500" style="height: auto;">
                                            </p>
                                            ...
                                            <h2 style="font-family: Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-weight: 500;font-size: 20px;color: #4F545C;letter-spacing: 0.27px;">
                                                Hey {{$details['name']}},</h2>
                                            <p>Wowwee! Thanks for registering an account with Discord! You're the
                                                coolest person in all the land (and I've met a lot of really cool
                                                people).</p>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;"
                                                    ...
                                                    <a href="{{route('registration.mail.verification',['user_id'=>$details['user_id'],'user_type'=>$details['user_type']])}}" style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
                                                        Verify Email
                                                    </a></td>
                                            </tr>
                                            </tbody>
                            ...
                            <tr>
                                <td style="word-break:break-word;font-size:0px;padding:14px 70px 30px 70px;"
                                    ...
                                    <div
                                        ...
                                        In Hearthstone, using the Hunter card Animal Companion against Kel'Thuzad will
                                        summon his cat Mr. Bigglesworth rather than the usual beasts.
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                                ...
                                <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                                    <div
                                        ...
                                        Sent by Discord • <a href="https://blog.discordapp.com/"
                                                             ...
                                                             target="_blank">check our blog</a> • <a
                                            href="https://twitter.com/discordapp"
                                            style="color:#1EB0F4;text-decoration:none;" target="_blank">@discordapp</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
