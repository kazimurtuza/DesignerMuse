    ...
    <div class="header__container container">
        ...
        <div class="header__nav u-flex u-flex--item-center">
            <ul class="header__nav__main u-flex u-flex--items-center">
                ...
                @endif
                <li>
                    <a @if(Auth::check()) href="{{route('user.cart.details')}}" @else onclick="firstLogin()" @endif class="cart-icon">
                        <span>
                ...
                <li class="d-flex align-items-center">
                    <label class="custom-dropdown profile-header d-flex align-items-center">
                        ...
                        <ul class="dd-menu">
                            ...
                            <li>
                                <a href="{{route('designer.pending.withdrawal.list')}}">Pending Withdrawal Request</a>
                            </li>
                            <li>
                                <a href="{{route('designer.completed.withdrawal.list')}}">Completed Withdrawal</a>
                            </li>
                            <li>
