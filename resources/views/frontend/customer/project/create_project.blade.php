...
{{--        </div>--}}
        <div class="form-outer">
            <form action="{{route('designer.project.store')}}" method="post" enctype="multipart/form-data">
                @csrf
...
{{--                    </div>--}}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="field">
                                ...
                                <input type="file" name="project_file" id="fileupload" style="padding-top: 9px;" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="field">
                                <label for="fileupload" class="form-label label">Project Date Line</label>
                                <input type="date" id="fileupload" name="date_line" required>
                            </div>
                        </div>
                    </div>
    ...
    {{--                        --}}{{-- Agreement Details--}}
    {{--                        --}}{{-- </h6>--}}
    {{--                        <textarea class="form-control" rows="10" name="agreement_info"></textarea>--}}
    {{--                    </div>--}}
    ...
    {{--                            Project Value--}}
    {{--                        </div>--}}
    {{--                        <input type="number" name="project_price" placeholder="Price">--}}
    {{--                    </div>--}}
