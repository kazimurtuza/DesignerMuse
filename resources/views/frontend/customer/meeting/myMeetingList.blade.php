...
{{--    </nav>--}}
    ...
    <section class="projects-table">
        <div class="projects-container container">
            <h2 class="title">{{languageGet()=='en'?'Pending Meeting List':'قائمة الاجتماعات المعلقة'}}</h2>
...
{{--                            <td class="text-center">{{$meeting->timeInfo->start_time}}</td>--}}
                            ...
                            <td class="text-center">{{$meeting->designer?$meeting->designer->name:''}}</td>
                            ...
                            <td class="text-center">
                                <a href="{{route('client.project.chat',['meeting_id'=>$meeting->id])}}"
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle drop-btn-style" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        {{languageGet()=='en'?'Consultation result':'نتيجة التشاور'}}

                                    </button>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="{{route('designer.meeting.outcome.update',['meeting_id'=>$meeting->id,'status'=>1])}}"> {{languageGet()=='en'?'Consultation only':'التشاور فقط'}}</a></li>
                                        <li><a class="dropdown-item" href="{{route('designer.create.project',['designer_id'=>$meeting->designer_id,'meeting_id'=>$meeting->id])}}">{{languageGet()=='en'?'Start the project':'ابدأ المشروع'}}</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
