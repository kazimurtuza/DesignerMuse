                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="{{route('designer.meeting.outcome.update',['meeting_id'=>$meeting->id,'status'=>1])}}">Consultation only</a></li>
                                        <li><a class="dropdown-item" href="{{route('designer.create.project',['designer_id'=>$meeting->designer_id,'meeting_id'=>$meeting->id])}}">Start the project</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
