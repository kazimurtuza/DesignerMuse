...
class AboutOusResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        if ($language == 'en') {
            return [
                ...
                'our_approach_tow_title' => $this->our_approach_tow_title_en,
                'our_approach_tow_details' => $this->our_approach_tow_details_en,
            ...
            return [
                ...
                'our_approach_left_img' => $this->our_approach_left_img,
                'our_approach_two_img' => $this->our_approach_two_img,
                'our_approach_tow_title' => $this->our_approach_tow_title_ar,
                'our_approach_tow_details' => $this->our_approach_tow_details_ar,
                'our_approach_three_img' => $this->our_approach_three_img,
